...
// Static page for the Visual Identity service
const service = servicesData.find(s => s.id === "visual-identity")
...
export default function VisualIdentityPage() {
  ...
  // Curated mapping from service id to relevant portfolio project IDs (3 projects max)
  const serviceToPortfolioIds: Record<string, string[]> = {
    "visual-identity": ["ibn-al-asti", "al-jazzar-steel", "al-habashi-furniture"],
    "graphic-design": ["king-wood", "al-jazzar-steel", "radwan-furniture"],
    "motion-graphics": ["testy-restaurant", "al-ula-export", "journey-start-academy"],
    "video-editing": ["testy-restaurant", "radwan-furniture", "al-ula-export"],
    "content-writing": ["journey-start-academy", "approved-achievement", "perfection-seeking-academy"],
    "sponsored-ads": ["high-brand-clothing", "king-wood-factory", "testy-restaurant"],
    "voiceover": ["al-ula-export", "testy-restaurant", "journey-start-academy"],
    "monthly-management": ["high-brand-clothing", "king-wood-factory", "al-ula-export"],
  }
    ...
    <div dir={isRTL ? "rtl" : "ltr"} lang={isRTL ? "ar" : "en"} className={`min-h-screen overflow-x-hidden ${isDark ? "bg-slate-900" : "bg-gray-50"}`}>
      ...
      <section className={`py-20 ${isDark ? "bg-gradient-to-br from-slate-900 to-slate-800" : "bg-gradient-to-br from-blue-50/30 to-white"}`}>
        <div className="container mx-auto px-4">
          ...
          <CompanyGallery serviceId={service.id} />
        </div>
      </section>
